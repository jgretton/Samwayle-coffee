          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-8 text-lg leading-9 text-[#444A4A]">
                ...
                is exactly the moment when a connection arises between us and
                our guests.
              </p>
              <br />
              <p className="mt-8 text-lg leading-9 text-[#444A4A]">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="mt-8 text-lg leading-9 text-[#444A4A]">
                  ...
                  diluted with hot water. The presence of foam (cream) depends
                  on how coffee and water are mixed. Attention! The concepts of
                  “American” and “American coffee” should not be confused. n the
                  second case, this refers not to diluted espresso, but to a
                  drink prepared through a filter system.
                </p>
        ...
        <Slide bottom>
          ...
          >
            ...
            <div className="container mx-auto flex flex-row space-x-5 items-center justify-center md:justify-between ">
              ...
              <div className="flex flex-col space-y-8 md:space-y-0 md:space-x-8 md:flex-row flex-shrink-0">
                <div className="flex flex-col justify-between text-center max-w-xs min-h-[458px] p-10 shop-shadow rounded-3xl bg-white min-w-min">
                  ...
                  <p className="mt-8 text-lg leading-9 text-[#444A4A]">
                    Espresso - black coffee made in a coffee machine or a
                    special coffee machine, where hot water is passed through
